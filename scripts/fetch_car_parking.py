...
Meters are not on that map; meters.json is left unchanged. Micromobility is
fetched by scripts/fetch_lime_parking.py (Lime GBFS). Bicycle parking is
fetched by scripts/fetch_bike_parking.py (OpenStreetMap / Overpass).
...
def http_get_json(url: str) -> dict:
    req = urllib.request.Request(
        url, headers={"User-Agent": "multimodality-fetch-car-parking/1.0"}
    )
...
def main() -> int:
    ...
    note_base = (
        "Generated by scripts/fetch_car_parking.py from the City of Grand Rapids "
