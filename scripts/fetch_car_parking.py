...
Meters and micromobility are not layers on that map; those JSON files are
left unchanged. Bicycle parking is fetched separately by
scripts/fetch_bike_parking.py (OpenStreetMap / Overpass).
"""
...
def main() -> int:
    ...
    note = (
        ...
        "Meters, micromobility, and bicycle parking are not fetched from this map."
    )
